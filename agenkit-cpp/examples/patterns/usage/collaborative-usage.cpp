 ...
 * Run: ./examples/collaborative_usage
 */
...
int main() {
    std::cout << "=== Collaborative Pattern Demo ===" << std::endl;
    ...
    // auto pattern = std::make_shared<CollaborativeAgent>(...);

    std::cout << "\n✅ Collaborative pattern example" << std::endl;
