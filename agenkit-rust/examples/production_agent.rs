...
//!
//! Demonstrates integration of checkpointing, budget tracking, and memory systems
//! for a production-ready conversational agent with durable execution, cost management,
//! and context-aware responses.
//!
//! Run with: cargo run --example production_agent
...
/// A production agent session with integrated systems.
...
impl ProductionSession {
    ...
    /// Process a message with full integration of all systems.
    ...
    fn generate_response(
            ...
            || message_text.to_lowercase().contains("hi")
        {
            if context.len() > 1 {
                ...
                "Hello! I'm your production agent with memory, budget tracking, and checkpointing. How can I assist you?".to_string()
            }
...
async fn main() -> Result<(), Box<dyn std::error::Error>> {
    println!("🚀 Production Agent Example");
    println!("{}", "=".repeat(60));
    println!("\nIntegrating: Checkpointing + Budget Tracking + Memory Systems\n");

    // ========================================================================
    // STEP 1: Setup Memory Hierarchy
    // ========================================================================
    println!("📝 Step 1: Setting up three-tier memory hierarchy...");
    ...
    // ========================================================================
    // STEP 2: Setup Budget Tracking
    // ========================================================================
    println!("📝 Step 2: Setting up budget tracking...");
    ...
    println!("  ✅ Warning at 80% threshold\n");

    // ========================================================================
    // STEP 3: Setup Checkpointing
    // ========================================================================
    println!("📝 Step 3: Setting up checkpointing for durable execution...");
    ...
    // ========================================================================
    println!("📝 Step 4: Creating production session...");
    ...
    println!("  ✅ Production session created");
    println!("  ✅ Session ID: {}\n", session_id);
