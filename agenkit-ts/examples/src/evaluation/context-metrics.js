...
exports.CompressionMetrics = exports.ContextMetrics = void 0;
exports.createCompressionStats = createCompressionStats;
exports.compressionStatsToDict = compressionStatsToDict;
/**
 ...
 */
function hasContextStats(agent) {
...
class ContextMetrics {
    ...
    async measure(agent, inputMessage, outputMessage, context) {
        ...
        if (ctx.conversationHistory && Array.isArray(ctx.conversationHistory)) {
            ...
            const totalTokens = history.reduce((sum, msg) => sum + this.estimateTokens(msg.content), 0);
            return totalTokens;
        }
        return 0;
    }
...
exports.ContextMetrics = ContextMetrics;
/**
 ...
 */
function createCompressionStats(rawTokens, compressedTokens, retrievalAccuracy, contextLengthTested) {
    return {
        rawTokens,
        compressedTokens,
 ...
 */
function compressionStatsToDict(stats) {
    return {
