...
exports.RouterPattern = exports.ParallelPattern = exports.SequentialPattern = void 0;
/**
...
exports.SequentialPattern = SequentialPattern;
/**
...
class ParallelPattern {
     ...
     */
    static defaultAggregator(messages) {
...
exports.ParallelPattern = ParallelPattern;
/**
...
class RouterPattern {
    ...
    async process(message) {
        ...
        throw new Error(`Router returned unknown key '${handlerKey}' and no default handler is configured`);
    }
    /**
