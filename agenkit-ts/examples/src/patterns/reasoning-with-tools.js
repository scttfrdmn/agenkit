...
exports.ReasoningWithToolsAgent = exports.ReasoningStepType = void 0;
exports.createReasoningStep = createReasoningStep;
exports.createReasoningTrace = createReasoningTrace;
exports.addStepToTrace = addStepToTrace;
exports.finalizeTrace = finalizeTrace;
exports.getTraceDuration = getTraceDuration;
exports.traceToDict = traceToDict;
const interfaces_1 = require("../core/interfaces");
/**
 * Type of reasoning step.
 */
var ReasoningStepType;
(function (ReasoningStepType) {
    ReasoningStepType["THINKING"] = "thinking";
    ReasoningStepType["TOOL_CALL"] = "tool_call";
    ReasoningStepType["TOOL_RESULT"] = "tool_result";
    ReasoningStepType["CONCLUSION"] = "conclusion";
})(ReasoningStepType || (exports.ReasoningStepType = ReasoningStepType = {}));
/**
 * Create a reasoning step.
 */
function createReasoningStep(stepNumber, stepType, content, options) {
    return {
        stepNumber,
        stepType,
        content,
 ...
 */
function addStepToTrace(trace, step) {
...
Begin reasoning. Use tools as needed while thinking.`;
        ...
        for (let stepNum = 0; stepNum < this.maxReasoningSteps; stepNum++) {
            ...
            const response = await this.llm.process((0, interfaces_1.createMessage)('user', currentContext));
            ...
            if (responseText.includes('TOOL_CALL:')) {
                ...
                if (toolName && this.tools.has(toolName)) {
                    ...
                    if (trace && remainingText.trim()) {
                        addStepToTrace(trace, createReasoningStep(stepNum, ReasoningStepType.THINKING, remainingText.trim()));
                    }
                    // Execute tool
                    ...
                    try {
                        ...
                        if (trace) {
                            addStepToTrace(trace, createReasoningStep(stepNum, ReasoningStepType.TOOL_CALL, `Called ${toolName}`, {
                                toolName,
                                toolParameters: parameters,
                            }));
                            addStepToTrace(trace, createReasoningStep(stepNum, ReasoningStepType.TOOL_RESULT, String(toolResult.data), {
                                toolName,
...
Continue reasoning with this information.`;
                        ...
                        if (trace) {
                            addStepToTrace(trace, createReasoningStep(stepNum, ReasoningStepType.TOOL_RESULT, errorMsg, { toolName }));
                        }
...
Continue.`;
                ...
                if (this.isConclusion(responseText)) {
                    ...
                    if (trace) {
                        addStepToTrace(trace, createReasoningStep(stepNum, ReasoningStepType.CONCLUSION, finalAnswer));
                    }
                    break;
                }
...
Continue reasoning or provide final answer.`;
        ...
        return (0, interfaces_1.createMessage)('assistant', finalAnswer, Object.keys(metadata).length > 0 ? metadata : undefined);
    }
    /**
...
exports.ReasoningWithToolsAgent = ReasoningWithToolsAgent;
