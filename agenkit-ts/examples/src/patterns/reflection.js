...
exports.ReflectionAgent = exports.CritiqueFormat = exports.StopReason = void 0;
const interfaces_1 = require("../core/interfaces");
/** Reason why reflection loop stopped */
var StopReason;
(function (StopReason) {
    StopReason["QUALITY_THRESHOLD_MET"] = "quality_threshold_met";
    StopReason["MINIMAL_IMPROVEMENT"] = "minimal_improvement";
    StopReason["MAX_ITERATIONS"] = "max_iterations";
    StopReason["PERFECT_SCORE"] = "perfect_score";
})(StopReason || (exports.StopReason = StopReason = {}));
/** Format expected from critic agent */
var CritiqueFormat;
(function (CritiqueFormat) {
    /** JSON: {"score": 0.8, "feedback": "..."} */
    CritiqueFormat["STRUCTURED"] = "structured";
    /** Free text with score extracted */
    CritiqueFormat["FREE_FORM"] = "free_form";
})(CritiqueFormat || (exports.CritiqueFormat = CritiqueFormat = {}));
/**
...
class ReflectionAgent {
    ...
    async process(message) {
        ...
        for (let iteration = 1; iteration <= this.maxIterations; iteration++) {
            ...
            const critiqueMessage = this.buildCritiquePrompt(String(message.content), String(output.content));
            ...
            const refineMessage = this.buildRefinementPrompt(String(message.content), String(output.content), feedback);
     ...
     */
    buildCritiquePrompt(originalQuery, currentOutput) {
        let prompt;
...
${currentOutput}`;
        ...
        return (0, interfaces_1.createMessage)('user', prompt);
    }
    /**
     * Build prompt for generator to refine output.
     */
    buildRefinementPrompt(originalQuery, currentOutput, critique) {
...
Please refine the output based on this feedback. Produce an improved version that addresses the critique.`;
     ...
     */
    checkStopConditions(score, improvement) {
        // Perfect score
        if (score >= 1.0) {
     ...
     */
    formatResult(output, stopReason) {
        const metadata = {
