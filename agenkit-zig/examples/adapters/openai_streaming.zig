...
///
/// This example shows how to stream responses from GPT models in real-time,
/// displaying text as it arrives from the API.
///
/// Run:
///   export OPENAI_API_KEY="your-key-here"
///   zig build run-openai-streaming

const std = @import("std");
const agenkit = @import("agenkit");
const OpenAILLM = agenkit.adapter.openai.OpenAILLM;
...
pub fn main() !void {
    ...
    std.debug.print("=== OpenAI GPT Streaming Example ===\n\n", .{});
    std.debug.print("Asking GPT to count to 10...\n\n", .{});
    ...
    std.debug.print("Asking GPT to write a short story...\n\n", .{});
    std.debug.print("Response (streaming):\n", .{});
    std.debug.print("{s}\n", .{"-" ** 60});
