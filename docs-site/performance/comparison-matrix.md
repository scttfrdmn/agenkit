...
2. **Overhead Benchmarks** ([benchmarks](benchmarks.md)): Measure middleware, transport, streaming overhead
...
- **[Pattern Performance Benchmarks](pattern-benchmarks.md)** - Comprehensive documentation
- **[Overhead Benchmarks](benchmarks.md)** - Middleware, transport, streaming
