...
Comprehensive learning path from beginner to production deployment.

## Overview

Follow these **5 progressive tutorials** to master Agenkit:
...
**Formats**:
- [Jupyter Notebook](../../tutorials/01-getting-started.ipynb)
- [Marimo Notebook](../../tutorials/01-getting-started.py) - Interactive with reactive UI
...
**Formats**:
- [Jupyter Notebook](../../tutorials/02-production-patterns.ipynb)
- [Marimo Notebook](../../tutorials/02-production-patterns.py) - Interactive with sliders/dropdowns

**Time**: 20-30 minutes | **Level**: Intermediate

**Marimo Features**: Interactive sliders for retry configuration, dropdowns for failure scenarios, real-time metrics toggle, cache performance tests
...
- Self-Consistency (SC) - Voting for reliability
- When to use each technique
- Combining techniques for maximum power

**Formats**:
- [Jupyter Notebook](../../tutorials/03-advanced-reasoning.ipynb)
- [Marimo Notebook](../../tutorials/03-advanced-reasoning.py) - Interactive parameter tuning

**Time**: 25-35 minutes | **Level**: Advanced

**Marimo Features**: Sliders for branching factor/depth (ToT), dropdowns for search/voting strategies, real-time technique comparison
...
**Directory**: [tutorials/04-deployment/](../../tutorials/04-deployment/)

**Files**: 16 working configuration files including Dockerfile, docker-compose.yml, Kubernetes manifests, CI/CD pipeline
...
**Format**: [Markdown Guide](../../tutorials/05-testing-patterns.md)
...
2. Explore [advanced examples](../examples/index.md)
...
- [280+ examples](../examples/index.md) across all patterns and languages

### Migration Guides
- [LangChain → Agenkit](../migrations/langchain-to-agenkit.md)
- [CrewAI → Agenkit](../migrations/crewai-to-agenkit.md)
- [AutoGen → Agenkit](../migrations/autogen-to-agenkit.md)
