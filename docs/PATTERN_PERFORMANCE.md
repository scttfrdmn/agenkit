...
These are documented in `benchmarks/BASELINES.md` but are **orthogonal to pattern benchmarks**.
...
- [Overhead Benchmarks](../benchmarks/BASELINES.md) - Middleware, transport, streaming overhead
- [Pattern Evaluation Framework](../agenkit/evaluation/pattern_benchmarks.py) - YAML-based behavior validation
- [C++ Benchmarks](../agenkit-cpp/benchmarks/BENCHMARKS.md) - C++ benchmark documentation
