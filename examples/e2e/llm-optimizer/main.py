...
from llm_optimizer import MODELS, ComplexityClassifier, CostTracker, LLMRouter
...
async def demo():
    ...
    test_requests = [
        {"prompt": "What is Python?", "description": "Simple factual query"},
        {
        ...
        {"prompt": "Write a function to sort a list", "description": "Medium coding task"},
        {
            "prompt": "I need medical advice about chest pain symptoms",
            "description": "Critical request",
        },
        {"prompt": "List 5 programming languages", "description": "Simple list request"},
    ]
