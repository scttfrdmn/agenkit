...
class SimpleEchoAgent(Agent):
    ...
    async def process(self, message: Message) -> Message:
        ...
        return Message(
            ...
            metadata={"original": message.content, "language": "python", "agent": self.name},
        )
...
async def test_message_creation():
    ...
    msg = Message(role="user", content="Hello", metadata={"test": True})
...
async def test_agent_metadata_preservation():
    ...
    msg = Message(role="user", content="Test", metadata={"request_id": "123"})
...
async def test_agent_with_complex_metadata():
    ...
    msg = Message(role="user", content="Complex test", metadata=complex_metadata)
...
async def test_message_immutability():
    ...
    msg = Message(role="user", content=original_content, metadata=original_metadata.copy())
